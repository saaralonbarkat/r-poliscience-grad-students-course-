...
subtitle: "R for Political Science Grad Students course 2024-25"
...
This file is a Quarto script file.
...
You can create and name "objects" and they will be saved in your "environment". To create an "object" use the sign "\<-"
...
The [,] structure enables you to extract an observation, and also a specific value of observation on a specific variable:
...
R also let's you create your own functions. e.g. - this very basic function will extract the sum of two numbers
...
Tidyverse is a set of packages that provide solutions to all of the stages in the data workflow (import, tidy, transform, visualize, model, communicate).
...
We will often use tidyverse in the course. We recommend you to get used to working with it (but you prefer to use base R that's also ok). In the end you will develop your own habits and coding style.
